...
Connect& set_clean_session(bool cs = true)  {
        _clean_session = cs; return *this;
}
//! Unset the "clear session" flag
Connect& unset_clean_session(void)    {
        _clean_session = false; return *this;
}
...
Publish& set_retain(bool r = true)  {
        _flags = (_flags & ~0x01) | r; return *this;
}
//! Unset retain flag
Publish& unset_retain(void)   {
        _flags = _flags & ~0x01; return *this;
}
...
Publish& unset_qos(void)    {
        _flags &= ~0x06; _need_packet_id = false; return *this;
}
...
Publish& set_dup(bool d = true) {
        _flags = (_flags & ~0x08) | (d ? 0x08 : 0); return *this;
}
//! Unset dup flag
Publish& unset_dup(void)    {
        _flags = _flags & ~0x08; return *this;
}
