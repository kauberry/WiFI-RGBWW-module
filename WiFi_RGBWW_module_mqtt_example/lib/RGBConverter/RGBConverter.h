...
public:
     ...
     *  @param _x  RGB single component as integer in the interval [0 .. 255]            (output)
     */
    static void rgbDoubleToESPInt_single(double x, unsigned int* _x);
    /**
     ...
     *  @param r     RGB red as integer in the interval [0 .. 1023]                   (output)
     *  @param g     RGB green as integer in the interval [0 .. 1023]                 (output)
     *  @param b     RGB blue as integer in the interval [0 .. 1023]                  (output)
     */
    static void rgbDoubleToESPInt(double r, double g, double b, unsigned int* _r, unsigned int* _g, unsigned int* _b);
    /**
     *  @brief rgbDoubleToInt Converts a floating point RGB color value (red, green and blue) into its integer representation
     *  @param r     RGB red as floating point in the interval [0.0 .. 1.0]          (input)
     *  @param g     RGB green as floating point in the interval [0.0 .. 1.0]        (input)
